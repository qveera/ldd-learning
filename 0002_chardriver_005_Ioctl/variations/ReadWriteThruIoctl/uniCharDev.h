...
/* UNI_READ_BUF: Read from the driver buffer */
#define UNI_READ_BUF		_IOR(UNI_MAGIC, 4, struct buf_info)

/* UNI_WRITE_BUF: Write to the driver buffer */
#define UNI_WRITE_BUF		_IOW(UNI_MAGIC, 5, struct buf_info)

#define UNI_MAX_CMDS		6
