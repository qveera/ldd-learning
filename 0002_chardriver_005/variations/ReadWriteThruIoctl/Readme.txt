...
ReadWrite through IOCTL:
------------------------
1) Create a struct to hold the buffer and size
2) Use the above struct as 3rd arg in the ioctl commands
3) Gather the info and call the previously implemented internal read or write function
